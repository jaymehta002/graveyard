  ...
  return (
    <>
        ...
        <Modal onClose={handleCancel}>
          <div className="bg-white text-black rounded-lg p-6">
            ...
            <input
              ...
              placeholder="Street"
              className="w-full mb-2 px-3 py-2 bg-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <input
              name="city"
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Country"
              className="w-full mb-4 px-3 py-2 bg-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <div className="flex justify-end">
              <button
                onClick={handleSave}
                className="px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-500 mr-2"
              >
                Save
              </button>
              <button
                onClick={handleCancel}
                className="px-4 py-2 bg-gray-100 text-black rounded-md hover:bg-gray-300"
              >
                Cancel
              </button>
            </div>
      ...
      <div className="p-4 bg-white rounded-lg text-black">
        ...
        <button
          onClick={handleEdit}
          className="px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-500 mt-4"
        >
          Edit
        </button>
      </div>
