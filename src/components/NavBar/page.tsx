      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <Link
              href="/"
              className="text-gray-200 font-black text-xl font-serif flex items-center"
            >
              GRAVEYARD
            </Link>
          </div>
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-4">
              ...
              <Link
                href="/cart"
                className="relative text-gray-300 hover:text-orange-500 px-3 py-2 rounded-md text-lg font-medium"
              >
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link
              href="/cart"
              className="text-gray-300 hover:text-orange-500 block px-3 py-2 rounded-md text-base font-medium relative"
            >
